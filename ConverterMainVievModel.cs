...
{
    internal class ConverterMainViewModel : BindableObject
    {
        ...
        private ConverterViewModel _firstValute;
        public ConverterViewModel firstValute => _firstValute;

        private ConverterViewModel _secondValute;
        public ConverterViewModel secondValute => _secondValute;
        ...
        private void takeValute()
        {
            ...
            _firstValute = new ConverterViewModel(CurrencyCharCodes, Exchange_data, 13);
            _secondValute = new ConverterViewModel(CurrencyCharCodes, Exchange_data, 43);
